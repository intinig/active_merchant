module ActiveMerchant #:nodoc:
  ...
  module Billing #:nodoc:
    class GlobalCollectGateway < Gateway      
      ...
      self.supported_cardtypes = [:visa, :master, :discover, :american_express, :jcb, :solo, :dankort, :laser, :visa_electron, :maestro]
      ...
      def credit_card_type(creditcard)
        {:visa => 1, :master => 3, :discover => 128, :american_express => 2, :jcb => 125, :solo => 118,  :dankort => 123, :laser => 124, :visa_electron => 122, :maestro => 117}[creditcard.type.to_sym]
      end
